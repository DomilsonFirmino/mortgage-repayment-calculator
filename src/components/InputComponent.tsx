  ...
  return (
    <div>
      <div className={`grid ${styles}`}>
        ...
        <div className={`grid grid-cols-[auto,1fr] border focus-within:border-lime-400 pointer-events-none rounded-sm overflow-hidden focus:bg-lime-100 mt-2 w-full  ${ error.length > 0 ? "border-Red" : "border-slate-700 "}`}>
          <input type="text" id={id} name={id} className={`${order} peer focus:border-none focus-visible:outline-none p-2 w-full pointer-events-auto`} value={state} onChange={handleChange}/>
