  ...
  return (
    <div>
      <div className={`grid ${styles}`}>
        ...
        <div className={`grid ${order == "order-2" ? "grid-cols-[auto,1fr]" : "grid-cols-[1fr,auto]"} border focus-within:border-lime-400 pointer-events-none hover:border-slate-900 rounded-sm overflow-hidden focus:bg-lime-100 mt-2 w-full  ${ error.length > 0 ? "border-Red" : "border-slate-700 "}`}>
